...
/**
 * Integración real con Polygon.io pendiente de implementar (Fase 2).
...
export class PolygonProvider implements PriceProvider {
  ...
  async getQuote(_company: CompanyFundamentals): Promise<PriceQuote | null> {
    throw new Error("PolygonProvider.getQuote: pendiente de implementar. Ver comentario de la clase.");
  }
}
