...
/**
 * Integración real con Finnhub pendiente de implementar (Fase 2).
...
export class FinnhubProvider implements PriceProvider {
  ...
  async getQuote(_company: CompanyFundamentals): Promise<PriceQuote | null> {
    throw new Error("FinnhubProvider.getQuote: pendiente de implementar. Ver comentario de la clase.");
  }
}
