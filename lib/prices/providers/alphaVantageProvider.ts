...
/**
 * Integración real con Alpha Vantage pendiente de implementar (Fase 2).
...
export class AlphaVantageProvider implements PriceProvider {
  ...
  async getQuote(_company: CompanyFundamentals): Promise<PriceQuote | null> {
    throw new Error("AlphaVantageProvider.getQuote: pendiente de implementar. Ver comentario de la clase.");
  }
}
